...
export const questions: Question[] = [
	{
		...
		options: [
			{ text: '💬 먼저 말 걸기', type: 'testosterone', value: 1 },
			{ text: '👀 눈빛으로 어필', type: 'estrogen', value: 1 },
			{ text: '😊 자연스럽게 웃으며', type: 'mixed', value: 0 },
			{ text: '🤔 상황 봐가며', type: 'estrogen', value: 1 },
		],
	},
	{
		question: 'Q2. 썸남/썸녀가 늦게 답장하면?',
		options: [
			{ text: '😤 바로 따지기', type: 'testosterone', value: 1 },
			{ text: '😢 속상하지만 참기', type: 'estrogen', value: 1 },
			{ text: '🤷‍♀️ 바쁜가보다 하기', type: 'mixed', value: 0 },
	...
	},
	{
		...
		options: [
			{ text: '🎯 내가 정해서 제안', type: 'testosterone', value: 1 },
			{ text: '💭 상대방 취향 고려', type: 'estrogen', value: 1 },
			{ text: '🤝 같이 의논해서', type: 'mixed', value: 0 },
			{ text: '😅 상대방에게 맡기기', type: 'estrogen', value: 1 },
		],
	},
	{
		question: 'Q4. 썸 상대가 다른 사람과 친하게 지내면?',
		options: [
			{ text: '🔥 직접 질문하기', type: 'testosterone', value: 1 },
			{ text: '😭 속으로만 질투', type: 'estrogen', value: 1 },
			{ text: '🧐 상황 파악하기', type: 'mixed', value: 0 },
	...
	},
	{
		...
		options: [
			{ text: '💪 나도 먼저 할걸', type: 'testosterone', value: 1 },
			{ text: '😊 받는 게 좋다', type: 'estrogen', value: 1 },
			{ text: '🤔 상황에 따라', type: 'mixed', value: 0 },
			{ text: '💕 로맨틱하게 받고 싶어', type: 'estrogen', value: 1 },
		],
	},
	{
		question: 'Q6. 데이트 중 갑자기 비가 오면?',
		options: [
			{ text: '🏃‍♂️ 빨리 뛰어가자', type: 'testosterone', value: 1 },
			{ text: '☔ 우산 하나로 같이', type: 'estrogen', value: 1 },
			{ text: '🏠 근처 카페로 피하기', type: 'mixed', value: 0 },
			{ text: '🌧️ 비 맞으며 걷기', type: 'estrogen', value: 1 },
		],
	},
	{
		question: 'Q7. 첫 키스는 언제?',
		options: [
			{ text: '💋 분위기 되면 바로', type: 'testosterone', value: 1 },
			{ text: '💖 특별한 날에', type: 'estrogen', value: 1 },
			{ text: '🤗 자연스럽게 될 때', type: 'mixed', value: 0 },
			{ text: '⏰ 충분히 알고 나서', type: 'estrogen', value: 1 },
		],
	},
	{
		question: 'Q8. 내 연애 표현 방식',
		options: [
			{ text: '💬 감정표현 자주 함', type: 'testosterone', value: 1 },
			{ text: '☺️ 티는 내지만 먼저는 못 함', type: 'estrogen', value: 1 },
			{ text: '🤗 먼저 말하면 맞장구', type: 'mixed', value: 0 },
	...
	},
	{
		...
		options: [
			{ text: '🗣️ 바로 대화로 해결', type: 'testosterone', value: 1 },
			{ text: '😔 시간 두고 풀기', type: 'estrogen', value: 1 },
			{ text: '🤝 서로 양보하기', type: 'mixed', value: 0 },
			{ text: '💌 편지나 메시지로', type: 'estrogen', value: 1 },
		],
	},
	{
		question: 'Q10. 기념일을 챙기는 스타일',
		options: [
			{ text: '📅 정확히 다 챙기기', type: 'testosterone', value: 1 },
			{ text: '💝 특별하게 준비', type: 'estrogen', value: 1 },
			{ text: '🎉 간단하게 축하', type: 'mixed', value: 0 },
			{ text: '💭 마음으로만', type: 'estrogen', value: 1 },
		],
	},
	{
		...
		options: [
			...
			{ text: '🤗 나를 따라와 주길', type: 'testosterone', value: 1 },
			{ text: '👫 서로 존중하며', type: 'mixed', value: 0 },
			{ text: '💕 로맨틱한 사랑', type: 'estrogen', value: 1 },
		],
	},
];
